...
router.post('/', async (req, res) => {
    ...
    const floors = getFloorsByProject(Number(project_id));
    const constructions = getConstructionsByProject(Number(project_id));
    const issues = getIssuesByProject(Number(project_id));
    try {
